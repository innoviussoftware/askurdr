...
class ClinicController extends Controller
{
    ...
    */
    ...
    public function create()
    {
        ...
        $page = '/admin/clinic';
        return view('admin.clinic.create', compact('page'));
    }
    ...
    */
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.clinic.index')
                      ->with(self::SUCCESS, 'Clinic added successfully.');
    }
    ...
    public function clinicarray(Request $request)
    {
        ...
        foreach ($clinic as $clinic) {
            ...
            if ($clinic['status'] == 1) {
                $verified_url = route('admin.clinic.changestatus', array($clinic_id , 0));
                ...
                $verified_url = route('admin.clinic.changestatus', array($clinic_id, 1));
            ...
            $delete_url = route('admin.clinic.delete', [$clinic_id]);

            $action = '<div class="btn-part"><a class="edit" href="' . route('admin.clinic.edit', $clinic_id) . '"><i class="fa fa-pencil-alt"></i></a>' . ' ';
    ...
    public function edit($id)
    {
        ...
        $page = '/admin/clinic';
        return view('admin.clinic.create', compact('clinic','page'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('admin.clinic.index')->with('success', 'Clinic deleted successfully.');
    }
    ...
    public function changestatus($id, $status)
    {
        ...
        if ($status == 1) {
            $msg = 'clinic is active successfully.';
        } elseif ($status == 0) {
            $msg = 'clinic is inactive successfully.';
        }

        return redirect()->route('admin.clinic.index')->with('success', ucfirst($clinic->name)." ".$msg);
    }
