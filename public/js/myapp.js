...
, function(e, t, n) {
    ...
    t.default = {
        props: ["userId", "chatId", "receptorName","senderName","receptorId"],
        data: function() {
            return {
                message: {
                    text: "",
            ...
            loadMessages: function(e) {
                ...
                for (var t in e)
                    this.historyMessages.push({
                        ...
                        //text: e[t].text,
                        // date: e[t].date,
                        sender_id:e[t].sender_id,
                        receiver_id:e[t].receiver_id,
                        message:e[t].message,
                        msg_type:'text',
...
, function(e, t) {
    var n = function() {
        ...
        return n("div", [e.firebaseMessagesLoaded ? e._e() : n("div", {
            ...
            return e.historyMessages.length > 0 ? n("div", {}, [e.isMe(t.sender_id) ? n("div", {
                ...
                staticClass: "author"
            }, [e._v(e._s(e.getUserName(t.receiver_id)))]), e._v(" "), n("div", {
                staticClass: "metadata"
            }, [n("span", {
                staticClass: "date"
            }, [e._v(e._s(e.humanize(t.date)))])]), e._v(" "), n("div", {
                staticClass: "text"
            }, [n("p", [e._v(e._s(t.message))])])])])])]) : e._e()
