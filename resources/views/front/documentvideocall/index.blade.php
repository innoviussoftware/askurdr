  	...
  	<div class="row">
        ...
        <nav aria-label="breadcrumb">
                  <ol class="breadcrumb" style="padding:8px 0px !important;">
                    <b>
                      <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('front.home.refferal') }}" class="breadcrumb-item active crumb">Listing :: Documents</a></li>
                    </b>
...
<script type="text/javascript">
  $(document).ready(function () {
        var doctordatatable = $('#medicinesdatatable').DataTable({
            ...
            "ajax": "{{ route('front.documentvideocall.array') }}",
            "language": {
