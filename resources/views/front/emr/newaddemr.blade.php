...
<div id='content' class="container col-md-10 col-md-offset-1  text well" align="">
    <div class="row">
      ...
      $id = auth()->user()->id;
      ?>
      <form method="post" action="{{ route('front.home.newemrStore') }}" enctype="multipart/form-data">
              @csrf
      ...
      <div class="col-md-6">
                 ...
                 <!--  <div class="form-group col-md-12">
                    ...
                    <input type="text" class="form-control" id="inputEmail4" placeholder="EMR No" value="{{}}" name="emrno" readonly="">
                  </div>
                   -->
                  <div class="col-md-12">
                     <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="form-group col-md-12">
                                    <select class="form-control form-control-sm required patientselect selectpicker" title="Search Patient" name="patients" id="medicines0" data-count="0" data-live-search="true" data-live-search-style="startsWith" required="">
                              ...
                              <div class="Investnew" id="newinvestment">
                                              ...
                                              <div class="form-group row">
                                                <div class="col-xs-12 col-sm-12 col-md-10">
                                                  <select class="form-control form-control-sm required select_subinvestigation"  title="Search Investigation" name="subinvestigation[]" id="subinvestigation0" data-count="0">
