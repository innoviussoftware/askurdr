          ...
          <form method="post" action="{{ route('front.home.updateprofile') }}" enctype="multipart/form-data">
            ...
            {{ method_field('POST') }}
              ...
              <div class="form-group col-md-12">
                ...
                <input type="text" class="form-control" id="inputAddress" placeholder="Mobile Number" value="{{$users->mobile}}" name="mobile" maxlength="10">
              </div>
              ...
              <div class="form-group col-md-12">
               ...
               <div class="form-group col-md-12">
                ...
                <select name="language" class="form-control">
                  ...
                  <option class="form-control" value="English"<?php if($users->language=='English'|| $users->language=='english'){ echo "selected"; }?>>English</option>
                  <option class="form-control" value="Arabic" <?php if($users->language=='Arabic'|| $users->language=='arabic'){ echo "selected"; }?> >Arabic</option>
