    ...
    <div class="invoice" style="padding-left: 2.2em;">
            ...
            <div class="row">
              ...
              <div class="col-xs-6">
                  ...
                  <label>{{isset($visit_investigation->patient)?$visit_investigation->patient->first_name:'adad'}} {{isset($visit_investigation->patient)?$visit_investigation->patient->last_name:'adasd'}}</label>
