...
<div id="content">
        ...
        <div class="container-fluid">
           <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                 <b>
                    <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('admin.refreal.index') }}" class="breadcrumb-item active crumb">Listing :: Referral</a></li>
                  </b>
                </ol>
            </nav>
          <!-- Page Heading -->
              ...
              <div class="row">
                <div class="col-lg-8">
                  <!-- <div class="caption font-dark">
                      ...
                      <span class="caption-subject bold uppercase" style="">Referral Listing</span>
                  </div> -->
                </div>
                <div class="col-lg-4">
                  <div class="row text-right">
                    ...
                    <div class="col-lg-4">
                      <a href="{{ route('admin.refreal.create') }}">
...
<script>
    $(document).ready(function () {
        var medicinesdatatable = $('#medicinesdatatable').DataTable({
            responsive: true,
            "processing": true,
            "ajax": "{{ route('admin.refreal.referalarray') }}",
            "language": {
