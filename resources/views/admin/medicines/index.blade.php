...
<div id="content">
        ...
        <div class="container-fluid">
           <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <b>
                    <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('admin.medicines.index') }}" class="breadcrumb-item active crumb">Listing :: Medicine</a></li>
                  </b>
                </ol>
            </nav>
          <!-- Page Heading -->
              ...
              <div class="row">
                <div class="col-lg-8">
                  <!-- <div class="caption font-dark">
                      ...
                      <span class="caption-subject bold uppercase" style="">Medicine Listing</span>
                  </div> -->
                </div>
                <div class="col-lg-4">
