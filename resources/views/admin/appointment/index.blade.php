...
<div id="content">
        ...
        <div class="container-fluid">
          ...
          <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                   <b>
                  <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('admin.prescriptionreport.index') }}" class="breadcrumb-item active crumb">Listing :: Appointment</a></li>
                </b>
                </ol>
          </nav>
          <!-- Page Heading -->
              ...
              <div class="row">
                ...
                <div class="col-lg-4">
                  <div class="row text-right">
                    ...
                    <!-- <div class="col-lg-4">
                      <a href="{{ route('admin.prescriptionreport.create') }}">
...
<script>
    $(document).ready(function () {
        var doctordatatable = $('#doctordatatable').DataTable({
            responsive: true,
            "processing": true,
            "ajax": "{{ route('admin.appointmentdetails.appointmentarray') }}",
            "language": {
                "emptyTable": "No Appointment available"
            },
            "order": [[0, "desc"]],
        });
