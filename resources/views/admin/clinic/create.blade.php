        ...
        <div class="container-fluid">
          ...
          <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  @if(isset($clinic))
                  <b>
                    <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('admin.clinic.index') }}" class="breadcrumb-item active crumb">Update :: Clinic</a></li>
                  </b>
                  @else
                  <b>
                    <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('admin.clinic.index') }}" class="breadcrumb-item active crumb">Add :: Clinic</a></li>
                  </b>
                  @endif
                </ol>
            </nav>
          ...
          <div class="row">
            ...
            <!-- <div class="col-4 text-right">
              <a href="{{ route('admin.clinic.index') }}" class="btn btn-secondary btn-sm rounded-circle"><i class="fa fa-arrow-left"></i></a>
            </div> -->
          </div>
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-8">
                  ...
                  @if(isset($clinic))
                    <form class="form-horizontal" action="{{ route('admin.clinic.update') }}" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="_method" value="PATCH">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    <input type="hidden" value="{{ $clinic->id }}" name="id" />
                  @else
                    <form class="form-horizontal" action="{{ route('admin.clinic.store') }}" method="post" enctype="multipart/form-data">
                  @endif
