                ...
                <div class="invoice" style="padding-left: 2.2em;margin-top: -3em;">
                    ...
                    <div class="row">
                      <div class="col-xs-12">
                          ...
                          <label>{{isset($visit_prescription->doctor->first_name)?$visit_prescription->doctor->first_name:''}}  {{isset($visit_prescription->doctor->last_name)?$visit_prescription->doctor->last_name:''}}</label>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-xs-12">
