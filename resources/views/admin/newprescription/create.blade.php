...
<div id="content" style="background-color: #ffff !important;">
        ...
        <div class="container-fluid">
           ...
           <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                 <b>
                    <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('admin.prescriptionreport.index') }}" class="breadcrumb-item active crumb">Add :: Prescription</a></li>
                  </b>
                </ol>
            </nav>
          <!-- Page Heading -->
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-8">
                    ...
                    <form class="form-horizontal" action="{{ route('admin.prescriptionreport.store') }}"method="post" enctype="multipart/form-data">
                    ...
                    <div class="disprecord">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                            ...
                            <input type="text" name="frequency2" class="form-control form-control-sm frequency2" value="" id="frequency20" required="required">
                        </div>
                        <div class="col-sm-2">
                          
                            <input type="text" name="frequency3" class="form-control form-control-sm frequency3" value="" id="frequency30" required="required">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            ...
                            <input type="text" name="duration" class="form-control form-control-sm duration" value="" id="duration0" required="required">
