...
<div id="content">
        ...
        <div class="container-fluid">
          ...
          <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                   <b>
                  <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('admin.prescriptionreport.index') }}" class="breadcrumb-item active crumb">Listing :: Prescription</a></li>
                </b>
                </ol>
          </nav>
          <!-- Page Heading -->
...
<script>
    $(document).ready(function () {
        var doctordatatable = $('#doctordatatable').DataTable({
            responsive: true,
            "processing": true,
            "ajax": "{{ route('admin.prescriptionreport.prescriptionarray') }}",
            "language": {
