        ...
        <div class="container-fluid">
          ...
          <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  @if(isset($clinic))
                  <b>
                    <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('admin.lang.index') }}" class="breadcrumb-item active crumb">Update :: Language</a></li>
                  </b>
                  @else
                  <b>
                    <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('admin.lang.index') }}" class="breadcrumb-item active crumb">Add :: Language</a></li>
                  </b>
                  @endif
                </ol>
            </nav>
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-8">
                  ...
                  @if(isset($clinic))
                    <form class="form-horizontal" action="{{ route('admin.lang.update') }}" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="_method" value="PATCH">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    <input type="hidden" value="{{ $clinic->id }}" name="id" />
                  @else
                    <form class="form-horizontal" action="{{ route('admin.lang.store') }}" method="post" enctype="multipart/form-data">
                  @endif
                    ...
                    @endif
                    <a href="{{route('admin.lang.index')}} " class="btn btn-secondary">Cancel</a>
