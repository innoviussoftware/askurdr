...
<div id="content">
        ...
        <div class="container-fluid">
           <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                 <b>
                    <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('admin.investigation.index') }}" class="breadcrumb-item active crumb">Listing :: Investigation</a></li>
                  </b>
                </ol>
            </nav>
          <!-- Page Heading -->
              ...
              <div class="row">
                ...
                <div class="col-lg-4">
                  <div class="row text-right">
                    ...
                    <div class="col-lg-4">
                      <a href="{{ route('admin.investigation.create') }}">
              ...
              <div class="table-responsive">
                ...
                <table class="table table-bordered" id="medicinesdatatable" width="100%" cellspacing="0">
                  <thead>
                    <tr>
                      <th></th>
                      <th>Test Name English</th>
                      <th>Test Name Arabic</th>
                      <th>Type</th>
                      <th>Status</th>
                      <th>Action</th>
                    </tr>
...
<script>
    $(document).ready(function () {
        var medicinesdatatable = $('#medicinesdatatable').DataTable({
            responsive: true,
            "processing": true,
            "ajax": "{{ route('admin.investigation.investigationarray') }}",
            "language": {
                "emptyTable": "No Sub-investigation available"
            },
            "order": [[0, "desc"]],
        });
