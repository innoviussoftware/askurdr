...
<div id="content">
        ...
        <div class="container-fluid">
           <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <b>
                    <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('admin.doctor.index') }}" class="breadcrumb-item active crumb">Listing :: Doctor</a></li>
                  </b>
              ...
              <div class="row">
                <div class="col-lg-8">
                  <!-- <div class="caption font-dark">
                      ...
                      <span class="caption-subject bold uppercase" style="">Doctor Listing</span>
                  </div> -->
                </div>
                <div class="col-lg-4">
...
@section('custom_js')
  <script>
      $(document).ready(function () {
          var doctordatatable = $('#doctordatatable').DataTable({
              responsive: true,
              "processing": true,
              "ajax": "{{ route('admin.doctor.doctorarray') }}",
              "language": {
  ...
  <script>
    ...
    var signUpObj = {};
      ...
      //   url:"",
      //   method:"post",
      //   data:"mobile="+signUpObj.username+"&sinch_ticket="+JSON.stringify(ticket),
      //   success:function(e){
      //     console.log();
      //   }
      // })
