            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-8">
                    ...
                    <form class="form-horizontal" action="{{ route('admin.patient.update',$prescription->id)}}"method="post" enctype="multipart/form-data">
                        <input type="hidden" name="prescription_id" value="{{$prescription->id}}" id="prescription_id">
                        <input type="hidden" name="doctor_id" value="{{$prescription->user_id}}" id="doctor_id">
                       @csrf
                       
                        {{ method_field('PATCH') }}
                       
                    
                    <input type="hidden" name="emr_number" value="{{$prescription->emr_number}}" id="doctor_id">
                    <div class="form-group row">
                      <label for="staticEmail" class="col-sm-3 col-form-label col-form-label-sm">Emr Number</label>
                      <div class="col-sm-9">
                        {{$prescription->emr_number}}
                      </div>
                    </div>
                     <div class="form-group row">
                      <label for="staticEmail" class="col-sm-3 col-form-label col-form-label-sm">Diagnosis<span class="text-danger">*</span></label>
                      <div class="col-sm-7">
                         <input type="text" name="diagnosis" class="form-control form-control-sm" value="{{$prescription->diagnosis}}" id = "automplete-1">
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-7">
                        <select class="form-control form-control-sm required select2 medicines_change" title="Search Medicines" name="medicines[]" id="medicines0" data-count="0">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-7">
                          ...
                          <input type="text" name="dose[]" class="form-control form-control-sm dose" value=""id="dose0">
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-7">
                          ...
                          <input type="text" name="route[]" class="form-control form-control-sm route" value=""id="route0">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-2">
                          <input type="text" name="frequency[]" class="form-control form-control-sm frequency1[]" value="" id="frequency10">
                      </div>
                      <div class="col-sm-2">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-7">
                          <input type="number" name="duration[]" class="form-control form-control-sm duration" value="" id="duration0">
                  ...
                  <?php }?>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-7">
                         <textarea class="form-control form-control-sm">{{$prescription->notetopharmacy}}</textarea>
                      </div>
                    </div>
            ...
            $.ajax({
                ...
                success:function(res){
                  ...
                  $.each(res, function(index, value) {
                     ...
                     $('#newprscs').append('<div class="box-body"><div class="form-group row"><label for="staticEmail" class="col-sm-3 col-form-label col-form-label-sm">Medicines Name<span class="text-danger">*</span></label><div class="col-sm-7"><select class="form-control form-control-sm required select2 medicines" title="Search Medicines" name="medicines[]"><option value="">Select Medicines</option><?php if(isset($medicines)){foreach($medicines as $medicine){?><option value="<?php echo $medicine->id ;?>" <?php if(in_array($medicine->id,$prescription_medicines)){?>selected="selected"<?php }?>><?php echo $medicine->name; ?></option><?php }}?></select></div><div class="col-sm-2"><button type="button" value="'+value.id+'" style="    margin-right: 0.5em;" class="removeprec btn btn-primary '+( (index >= 0) ? 'd-none' : '')+'" name="remove_id"><i class="fa fa-minus"></i></button><button type="button" style="" class="addprec btn btn-primary '+( (index > 0) ? 'd-none' : '' )+'" value="'+value.id+'" name="addnew_id" ><i class="fa fa-plus"></i></button></div></div><div class="form-group row"><label for="staticEmail" class="col-sm-3 col-form-label col-form-label-sm">Dose<span class="text-danger">*</span></label><div class="col-sm-7"><input type="text" name="dose[]" class="form-control form-control-sm dose" value="'+value.dose+'"></div></div><div class="form-group row"><label for="staticEmail" class="col-sm-3 col-form-label col-form-label-sm">Route<span class="text-danger">*</span></label><div class="col-sm-7"><input type="text" name="route[]" class="form-control form-control-sm route" value="'+value.route+'"></div></div><div class="form-group row"><label for="staticEmail" class="col-sm-3 col-form-label col-form-label-sm">Frequency<span class="text-danger">*</span></label><div class="col-sm-2"><input type="text" name="frequency1[]" class="form-control form-control-sm frequency1" value="'+value.frequency+'"></div><div class="col-sm-2"><input type="text" name="frequency2[]" class="form-control form-control-sm frequency2" value="'+value.frequency2+'"></div><div class="col-sm-2"><input type="text" name="frequency3[]" class="form-control form-control-sm frequency3" value="'+value.frequency3+'"></div></div><div class="form-group row"><label for="staticEmail" class="col-sm-3 col-form-label col-form-label-sm">Duration<span class="text-danger">*</span></label><div class="col-sm-7"><input type="number" name="duration[]" class="form-control form-control-sm" value="'+value.duration+'"><input type="hidden" value="'+value.id+'" name="medicines_pre" id="pre_id"></div></div></div>');
                        $('.select2').select2();
                  });
