            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-8">
                    ...
                    <form class="form-horizontal" action="{{ route('admin.prescription.store')}}"method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-7">
                         <input type="text" name="diagnosis" class="form-control form-control-sm" value="{{ old('diagnosis') }}" id = "automplete-1">
                      </div>
                    </div>
                    ...
                    <div class="disprecord">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                            ...
                            <input type="text" name="frequency1[]" class="form-control form-control-sm frequency1" value="" id="frequency10">
