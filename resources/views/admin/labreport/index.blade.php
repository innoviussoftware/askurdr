...
<div id="content">
        ...
        <div class="container-fluid">
           <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                 <b>
                    <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('admin.investigationreport.index') }}" class="breadcrumb-item active crumb">Listing :: Investigation Report</a></li>
                  </b>
                </ol>
            </nav>
          <!-- Page Heading -->
...
<script>
    $(document).ready(function () {
        var medicinesdatatable = $('#medicinesdatatable').DataTable({
            responsive: true,
            "processing": true,
            "ajax": "{{ route('admin.investigationreport.reportarray') }}",
            "language": {
