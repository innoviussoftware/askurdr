...
<div id="content">
        ...
        <div class="container-fluid">
             ...
             <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <b>
                    <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('admin.wallet.index') }}" class="breadcrumb-item active crumb">Listing :: Call</a></li>
                  </b>
                </ol>
            </nav>
          <!-- Page Heading -->
                ...
                <table class="table table-bordered" id="clinicdatatable" width="100%" cellspacing="0">
                  <thead>
                    <tr>
                      ...
                      <th>Patient Name</th>
                      <th>Call Type</th>
                      <th>Total Call Time (HH:MM:SS)</th>
                    </tr>
                  </thead>
                  <tbody>
                  </tbody>
...
<script>
    $(document).ready(function () {
        var clinicdatatable = $('#clinicdatatable').DataTable({
            responsive: true,
            "processing": true,
            "ajax": "{{ route('admin.callLog.array') }}",
            "language": {
                "emptyTable": "No callLog available"
            },
            "order": [[0, "desc"]],
        });
